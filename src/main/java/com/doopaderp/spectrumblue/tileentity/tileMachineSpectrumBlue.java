...
public class tileMachineSpectrumBlue extends TileEntity implements IEnergyHandler, ISidedInventory
{
    private String _name;
    public tileMachineSpectrumBlue(String name)
    {
       _name = name;
    }
    ...
    protected tileInventory inventory;
