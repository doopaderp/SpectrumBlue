...
import com.doopaderp.spectrumblue.containers.baseContainer;
...
public class GuiBaseMachine extends GuiContainer
{
    ...
    private tileMachineSpectrumBlue tile;
    private ResourceLocation backgroundimage = new ResourceLocation(Reference._PREFIX + "textures/gui/GuiMagneticOrganizer.png");

    public GuiBaseMachine(InventoryPlayer inventory, tileMachineSpectrumBlue tileEntity) {
        super(new baseContainer(inventory, tileEntity));
    ...
    protected void drawGuiContainerForegroundLayer(int param1, int param2) {
        ...
        fontRendererObj.drawString("Magnetic Organizer", xSize/2 - (fontRendererObj.getStringWidth("Magnetic Organizer")/2), 5, 4210752);
